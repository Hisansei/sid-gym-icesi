...
ALTER TABLE USERS ADD CONSTRAINT USERS_STUDENTS_FK FOREIGN KEY (student_id) REFERENCES STUDENTS (id);
ALTER TABLE USERS ADD CONSTRAINT USERS_EMPLOYEES_FK FOREIGN KEY (employee_id) REFERENCES EMPLOYEES (id);
ALTER TABLE USERS ADD CONSTRAINT USERS_ONE_ROLE_CHK CHECK (
    (student_id IS NOT NULL AND employee_id IS NULL)
        OR (student_id IS NULL AND employee_id IS NOT NULL)
    );

ALTER TABLE STUDENTS    ADD CONSTRAINT STUDENTS_CITIES_FK     FOREIGN KEY (birth_place_code) REFERENCES CITIES (code);
ALTER TABLE STUDENTS    ADD CONSTRAINT STUDENTS_CAMPUSES_FK    FOREIGN KEY (campus_code)      REFERENCES CAMPUSES (code);
...
ALTER TABLE ENROLLMENTS ADD CONSTRAINT ENROLLMENTS_STUDENTS_FK   FOREIGN KEY (student_id) REFERENCES STUDENTS (id);
ALTER TABLE ENROLLMENTS ADD CONSTRAINT ENROLLMENTS_GROUPS_FK     FOREIGN KEY (NRC)        REFERENCES GROUPS (NRC);
...
ALTER TABLE trainer_monthly_stats ADD CONSTRAINT trainer_monthly_stats_pk PRIMARY KEY (trainer_username, period);
ALTER TABLE trainer_monthly_stats ADD CONSTRAINT trainer_monthly_stats_users_fk FOREIGN KEY (trainer_username) REFERENCES users (username);
