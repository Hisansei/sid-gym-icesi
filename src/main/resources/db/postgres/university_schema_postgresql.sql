...
-- -----------------------------
CREATE TABLE USERS (
                       username        VARCHAR(100) NOT NULL,  -- << ampliado a 100
                       password_hash   VARCHAR(255) NOT NULL,  -- << ampliado a 255
                       role            VARCHAR(50)  NOT NULL,  -- mantener compatibilidad v1/v5
...
-- Relaciones opcionales: un usuario corresponde a un estudiante o a un empleado
...
-- Un usuario no puede ser estudiante y empleado a la vez
...
-- NUEVA: métricas de usuario por mes (routines_started, followups_made)
