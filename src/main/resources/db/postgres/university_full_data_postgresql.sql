-- =========================
-- University Full Data (PostgreSQL)
...
-- Insert Faculties (dean_id en NULL para evitar el ciclo; se actualiza más abajo)
...
-- Ahora que existen los EMPLOYEES, asignamos los decanos originales
...
ALTER TABLE PROGRAMS ADD CONSTRAINT PROGRAMS_AREAS_FK
    FOREIGN KEY (area_code) REFERENCES AREAS (code);

ALTER TABLE CAMPUSES ADD CONSTRAINT CAMPUSES_CITIES_FK
...
-- =========================
-- "Cosita" para informes (instructores por mes)
-- =========================
