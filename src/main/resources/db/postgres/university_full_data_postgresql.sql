...
-- =========================
-- Insert Faculties
--  (dean_id en NULL para evitar ciclo con EMPLOYEES;
--   se actualiza al final de este archivo)
-- =========================
...
-- =========================
-- Insert Users (estudiantes + empleados)
--  (La app luego actualiza password_hash a BCrypt; ver bloque final)
-- =========================
INSERT INTO USERS (
