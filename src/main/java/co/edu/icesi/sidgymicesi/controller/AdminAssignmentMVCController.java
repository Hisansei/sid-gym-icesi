...
public class AdminAssignmentMVCController {
    ...
    public String create(@RequestParam String userUsername,
        ...
        ra.addFlashAttribute("message", "Asignado " + userUsername + " → " + trainerUsername);
    ...
    public String reassignForm(@RequestParam String userUsername, Model model) {
        ...
        model.addAttribute("current", assignmentService.findActiveByUser(userUsername).orElse(null));
    ...
    public String reassign(@RequestParam String userUsername,
        ...
        ra.addFlashAttribute("message", "Reasignado " + userUsername + " → " + newTrainerUsername);
        return "redirect:/mvc/admin/assignments";
    }
